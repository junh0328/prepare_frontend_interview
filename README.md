...
안녕하세요! `prepare_frontend_interview` 를 관심 가져 주시는 모든 주니어 FE 개발자분들 및 취준생 분들께 감사 인사드립니다.

현재 저는 이 문서를 작성한 이후, 해당 문서를 바탕으로 열심히 준비해서 모 스타트업에 취직하게 되었습니다. 이제는 취준생이 아닌 주니어 개발자로서의 삶을 살아가고 있습니다. 회사 계정을 병행하게 되어 해당 문서의 업데이트 빈도가 낮아졌네요.

이전 만큼의 빈도로 업데이트하기는 힘들지만, 앞으로도 저를 포함한 취준생 그리고 주니어 FE 분 들을 위해 제가 배우는 다양한 소식에 대해 업데이트 해보겠습니다. 많은 관심과 참여 부탁드릴게요!

`해당 추가 본은 4월 23일 삭제할 예정입니다`

### +) 2022.03.29 추가

'피면접자'가 생각하는 예상 질문 리스트를 추가하였습니다.

면접을 보진 않더라도, 이런 질문이 들어 왔을 때 어떻게 대답하면 좋을까 라는 생각을 가지고 만들고 있는 리스트입니다.

실제 면접 후기 리스트와 병행하여 작성해 볼 예정입니다.
